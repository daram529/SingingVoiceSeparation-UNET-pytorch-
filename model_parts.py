...
class down(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(in_channels=in_ch, out_channels=out_ch, kernel_size=4, stride=2, padding=1),
...
class final_conv(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.convTrans = nn.ConvTranspose2d(in_channels=in_ch, out_channels=out_ch, kernel_size=4, stride=2, padding=1)
